...
class TestShell:
    """Wrapper Class for BlinkhashTestFramework.

    The TestShell class extends the BlinkhashTestFramework
    ...
    class __TestShell(BlinkhashTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BlinkhashTestFramework child class.
            self.num_nodes = 1
