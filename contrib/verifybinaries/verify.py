...
blinkhash.com and bitcoin.org and compares them.
...
def main(args):
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("bitcoin.org and blinkhash.com signature files were not equal?")
