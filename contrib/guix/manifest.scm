...
(define* (make-blinkhash-cross-toolchain target
                                       #:key
...
desirable for building Blinkhash Core release binaries."
...
(define glibc-2.27/blinkhash-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-blinkhash-cross-toolchain target
                                                      #:base-libc glibc-2.27/blinkhash-patched
