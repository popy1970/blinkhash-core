...
def main():
    ...
    # Filter out hosts with multiple blinkhash ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple blinkhash ports' % (ip_stats(ips)), file=sys.stderr)
