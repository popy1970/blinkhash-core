...
#ifndef BLINKHASH_COMPAT_ASSUMPTIONS_H
#define BLINKHASH_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Blinkhash cannot be compiled without assertions."
#endif
...
#endif // BLINKHASH_COMPAT_ASSUMPTIONS_H
