...
#ifndef BLINKHASH_PROTOCOL_H
#define BLINKHASH_PROTOCOL_H
...
/**
 * Blinkhash protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Blinkhash Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Blinkhash Core nodes used to support this by default, without advertising this bit,
    ...
    // blinkhash-development mailing list. Remember that service bits are just
