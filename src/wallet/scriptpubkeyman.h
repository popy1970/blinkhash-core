...
#ifndef BLINKHASH_WALLET_SCRIPTPUBKEYMAN_H
#define BLINKHASH_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Blinkhash Core wallet was originally a collection of unrelated private
...
#endif // BLINKHASH_WALLET_SCRIPTPUBKEYMAN_H
