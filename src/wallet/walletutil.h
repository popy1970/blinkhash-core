...
#ifndef BLINKHASH_WALLET_WALLETUTIL_H
#define BLINKHASH_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! blinkhash from opening the wallet, thinking it was newly created, and
...
#endif // BLINKHASH_WALLET_WALLETUTIL_H
