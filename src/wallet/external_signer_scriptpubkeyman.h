...
#ifndef BLINKHASH_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BLINKHASH_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BLINKHASH_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
