...
#ifndef BLINKHASH_INTERFACES_INIT_H
#define BLINKHASH_INTERFACES_INIT_H
...
//! (blinkhash-gui, blinkhash-node, blinkhash-wallet, blinkhashd, blinkhash-qt) and each
...
#endif // BLINKHASH_INTERFACES_INIT_H
