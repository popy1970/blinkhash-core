...
#ifndef BLINKHASH_RPC_PROTOCOL_H
#define BLINKHASH_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in blinkhashd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Blinkhash is not connected
...
#endif // BLINKHASH_RPC_PROTOCOL_H
