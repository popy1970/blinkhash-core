...
#ifndef BLINKHASH_UTIL_MESSAGE_H
#define BLINKHASH_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's blinkhash address, it must refer to a public key.
...
#endif // BLINKHASH_UTIL_MESSAGE_H
