...
//! Entry point for BlinkhashApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BlinkhashApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BlinkhashGUI tests.
void AppTests::guiTests(BlinkhashGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BlinkhashGUI::consoleShown, this, &AppTests::consoleTests);
