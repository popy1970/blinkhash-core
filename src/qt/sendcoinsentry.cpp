    ...
    platformStyle(_platformStyle)
{
    ...
    // normal blinkhash address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying blinkhash address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BlinkhashAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
