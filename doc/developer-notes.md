...
with "play blinkhash" on a test network.
...
Some of these are maintained by active developers of Blinkhash Core, in which case changes should probably go
directly upstream without being PRed directly against the project. They will be merged back in the next
subtree merge.

Others are external projects without a tight relationship with our project. Changes to these should also
be sent upstream, but bugfixes may also be prudent to PR against Blinkhash Core so that they can be integrated
