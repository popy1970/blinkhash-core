...
This document provides guidelines for internationalization of the Blinkhash Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `blinkhash_en.ts` remains unchanged.
