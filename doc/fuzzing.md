...
# libFuzzer" on https://github.com/blinkhash/blinkhash-core/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/blinkhash/blinkhash-core/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/blinkhash/blinkhash-core/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/blinkhash/blinkhash-core/tree/master/src/test/fuzz).
...
Every single pull request submitted against the Blinkhash Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Blinkhash Core more robust.
...
with certain assembly code from Blinkhash Core's code. See [developer notes on sanitizers](https://github.com/blinkhash/blinkhash-core/blob/master/doc/developer-notes.md#sanitizers)
